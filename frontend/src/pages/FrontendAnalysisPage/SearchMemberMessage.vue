<template>
  <div class="my-2 flex flex-col h-full overflow-hidden">
    ...
    <div class="grow pt-2 px-2 pb-5 grow h-full overflow-y-auto">
      <div v-if="memberMessages !== null" class="text-xl text-red-5">總計數量: {{ memberMessages.length }}</div>
